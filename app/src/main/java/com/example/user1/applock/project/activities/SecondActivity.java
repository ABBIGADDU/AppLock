...
import com.example.user1.applock.patternview_reactive.RxPatternLockView;
...
import com.example.user1.applock.project.controllers.Utilities;
...
public class SecondActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPatternLockView = (PatternLockView) findViewById(R.id.pattern_view);
        ...
        RxPatternLockView.patternComplete(mPatternLockView)
                .subscribe(new Consumer<PatternLockCompleteEvent>() {
                    ...
                    public void accept(PatternLockCompleteEvent patternLockCompleteEvent) throws Exception {
                        ...
                        if (Utilities.compareTwoPatterns(Singleton.getInstance().getLstFirstSavingDots(), patternLockCompleteEvent.getPattern())) {
                            startActivity(new Intent(SecondActivity.this, MainActivity.class));
                            SessionManager sessionManager = new SessionManager(SecondActivity.this);
                            sessionManager.setMemberLockPattern(patternLockCompleteEvent.getPattern().toString());
